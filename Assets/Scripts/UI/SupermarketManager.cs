...
public class SupermarketManager : MonoBehaviour
{
    ...
    {
         dialogue.Say(activeBuyer.GetComponent<CharacterData>().phrases.ElementAt(phraseID), activeBuyer.GetComponent<CharacterData>().phrases.ElementAt(Constants.NAME));
    }
